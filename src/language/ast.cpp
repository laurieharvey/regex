...
namespace regex
{
    namespace language
    {
        ...
        character::character(character_type value)
            : value_(value)
        {
        }
        ...
        parenthesis::parenthesis(std::unique_ptr<token> lhs)
            : lhs_(std::move(lhs))
        {
        }
        ...
        kleene::kleene(std::unique_ptr<token> lhs)
            : lhs_(std::move(lhs))
        {
        }
        ...
        zero_or_one::zero_or_one(std::unique_ptr<token> lhs)
            : lhs_(std::move(lhs))
        {
        }
        ...
        one_or_more::one_or_more(std::unique_ptr<token> exp)
            : exp_(std::move(exp))
        {
        }
