...
namespace regex
{
    ...
    public:
         ...
         */
        static void merge(std::shared_ptr<dstate> src, std::shared_ptr<dstate> target, std::set<std::shared_ptr<dstate>> visited = std::set<std::shared_ptr<dstate>>( ) );
        /*
         ...
         *  to completion
         */
        static void copy(std::shared_ptr<const dstate> src, std::shared_ptr<dstate> target, std::set<std::shared_ptr<dstate>> visited = std::set<std::shared_ptr<dstate>>( ) );
        /*
